...
const char *ssid = "realme X2";     // Enter SSID here
const char *password = "24680123"; //Enter Password here
...
{
  char buffer[128];
  sprintf(buffer,"%f;%f",BPM,SpO2);
//    server.send(200, "text/html", sendResponse(BPM, SpO2));
...
String sendResponse(float bpm, float spo2)
{
    String str = String(bpm) + ";" + String(spo2);
    return str;
}
